...
export default function NotepadRoomPage() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Left: Hanuman Logo and anil6 Brand Name */}
        <div className="flex items-center gap-3">
          <a href="/" className="flex items-center gap-2.5 group font-bold tracking-tight text-sm">
            {/* Styled Divine Hanuman Logo Avatar */}
            <div className="relative flex h-8 w-8 items-center justify-center rounded-lg overflow-hidden shadow-md shadow-orange-500/40 group-hover:scale-105 transition-all duration-200 border border-amber-400/40">
              <img
