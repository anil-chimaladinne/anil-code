      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl border border-[#2e2e38] bg-[#18181c]/95 p-7 sm:p-8 shadow-2xl backdrop-blur-xl animate-in zoom-in-95 duration-200 overflow-hidden">
        ...
        {step === "input" ? (
          ...
          <form onSubmit={handleVerifyCode} className="space-y-4">
            <div className="p-3.5 rounded-xl bg-[#202026] border border-[#2d2d38] text-center space-y-1">
              ...
              <p className="text-[11px] text-gray-400">
                ...
                <span className="font-mono text-orange-400 font-bold">{target}</span>. Please enter it below.
              </p>
            </div>
